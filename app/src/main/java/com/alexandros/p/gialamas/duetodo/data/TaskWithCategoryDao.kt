...
import com.alexandros.p.gialamas.duetodo.data.models.TaskWithCategoryTable
import kotlinx.coroutines.flow.Flow

@Dao
interface TaskWithCategoryDao {

    @Query("SELECT * FROM todo_task_table LEFT JOIN category_task_table ON todo_task_table.categoryId = category_task_table.id")
    ...
    suspend fun addTaskWithCategory(taskWithCategoryTable: TaskWithCategoryTable)
